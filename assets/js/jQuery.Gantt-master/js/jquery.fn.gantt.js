        ...
        var core = {
            ...
            rightPanel: function (element, leftPanel /* <- never used? */) {
                ...
                case "weeks":
                    ...
                    year = range[0].getFullYear();
                    month = range[0].getMonth();
                    // week = range[0].getWeekOfMonth();
                    week = getWeekOfMonth(range[0]);
                    ...
                    for (i = 0, len = range.length; i < len; i++) {
                        ...
                        if (rday.getMonth() !== month) {
                            ...
                            monthArr.push(
                                ...
                                settings.months[month] +
                                '</div></div>');
                                // '<div class="row month" style="width: 96px;"><div class="fn-label">' +
                                // settings.months[month] +
                                // '</div></div>');
                            month = rday.getMonth();
                        ...
                        dayArr.push(
                            ...
                            '" data-offset="' + i * tools.getCellSize() +
                            '" data-repdate="' + rday.getRepDate(settings.scale) + '">' +
                            '<div class="fn-label">' + _week + '</div></div>');
                    }
